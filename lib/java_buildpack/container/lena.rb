  ...
  module Container
    ...
    class Lena < JavaBuildpack::Component::VersionedDependencyComponent
      ...
      def update_configuration
        ...
        modified = standalone_config.read.gsub(/<virtual-server name="default-host" enable-welcome-root="true">/,
                           '<virtual-server name="default-host" enable-welcome-root="false">').gsub(/<socket-binding name="http" port="8080"\/>/,
