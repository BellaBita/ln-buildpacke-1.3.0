...
# 본 Git은 PaaS-TA 빌드팩을 구현하기 위한 임시 Git입니다. 
Java Runtime 환경을 확장하기 위해 전자정부 프레임워크 Git을 원안으로 재구성 하고 있는 중입니다. 
이하의 모든 내용은 PaaS-TA 전자정부 프레임워크(egovframework) 빌드팩 내용임을 알려드립니다. 
