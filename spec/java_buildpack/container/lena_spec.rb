...
describe JavaBuildpack::Container::Lena do
  include_context 'component_helper'

  let(:component) { StubLena.new context }
  ...
  it 'extracts LENA from a GZipped TAR',
...
class StubJboss < JavaBuildpack::Container::Lena
